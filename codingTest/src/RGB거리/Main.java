...
// 풀이
// 현재 들어온 RGB 색상 값에 이전에 계산된 값들을 재사용 해서 뭐가 더 싼지 고려함.
// 따라서 현재 R G B 색상 가격에 이전 (같은 색상 제외) 중 더 싼 값을 현재 내 값과 더해서 
// 현재 내 색상과 만들어 낼 수 있는 최소값 만들어 낸 뒤
// 맨 마지막 케이스 에서 나온 결과값 세 개 중 제일 가격이 싼 케이스 정답.
